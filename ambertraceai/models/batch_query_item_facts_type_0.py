...
T = TypeVar("T", bound="BatchQueryItemFactsType0")


@_attrs_define
class BatchQueryItemFactsType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        batch_query_item_facts_type_0 = cls()
        ...
        batch_query_item_facts_type_0.additional_properties = additional_properties
        return batch_query_item_facts_type_0
